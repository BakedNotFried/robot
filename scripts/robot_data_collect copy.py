...
class RobotDataCollector(InterbotixRobotNode):
    def __init__(self):
        ...
        # Control Callback based on Omni Teleoperation State. Check Omni State for publish rate - currently 50Hz
    ...
    def robot_control_callback(self, msg):
        ...
        if (self.kb.record_state == RECORDING) or (self.kb.record_state == CONTROL):
            ...
            open_gripper = tele_state[6]
            close_gripper = tele_state[7]
